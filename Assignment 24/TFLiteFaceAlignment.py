...
if __name__ == '__main__':
    ...
    while True:
        ...
        for pred in fa.get_landmarks(frame, boxes):
            ...
            lip_height_distance = distance.euclidean(landmarks_lips[0][9], landmarks_lips[0][3])
            lip_weight_distance = distance.euclidean(landmarks_lips[0][0], landmarks_lips[0][6])
            total = lip_height_distance / lip_weight_distance
